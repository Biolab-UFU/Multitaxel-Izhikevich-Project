 ...
 */
void switch_column(uint8_t coluna) {
    ...
    switch (coluna) {
        case 0: HAL_GPIO_WritePin(COLUNA_0_GPIO_Port, COLUNA_0_Pin, GPIO_PIN_RESET); break;
        case 1: HAL_GPIO_WritePin(COLUNA_1_GPIO_Port, COLUNA_1_Pin, GPIO_PIN_RESET); break;
        case 2: HAL_GPIO_WritePin(COLUNA_2_GPIO_Port, COLUNA_2_Pin, GPIO_PIN_RESET); break;
        case 3: HAL_GPIO_WritePin(COLUNA_3_GPIO_Port, COLUNA_3_Pin, GPIO_PIN_RESET); break;
        default: break;
    }
}
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim) {
    ...
    if (htim == &htim6) { // Verifica se a interrupção veio do Timer 6
        ...
        update_taxels(&taxels[current_column * 4], adc_values, 4);

        // Alterna para a próxima coluna
        switch_column(current_column);
